<template>
    <div class="params">
        ...
        <div class="form-group">
            ...
            <span class="form-tooltip" v-tooltip.right="'Number of generations'"><span class="glyphicon glyphicon-question-sign"></span></span>
            <div class="">
        ...
        <div id="selection">
            ...
            <div class="form-group" id="tourney" v-if="params.selectionType === '2'">
