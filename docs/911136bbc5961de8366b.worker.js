...
var AnnealingSolver = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(AnnealingSolver, [{
        ...
        value: function solve(problem, params) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_3__common_Result_js__["a" /* default */](problem.getResult(currentConfiguration), problem.getProblemCost(currentConfiguration), counter);
        }
        /**
        ...
        value: function computeStartingTemp(problem) {
            ...
            while (50 * size !== arrayOfEnergyStates.length) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_math_sign___default()(conf) === __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_math_sign___default()(neigh)) {
                    if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_math_sign___default()(conf) === -1) {
                        conf = -conf;
                        neigh = -neigh;
                    }
                    newEnergyState = {
        ...
        key: 'computeInnerCycle',
        value: function computeInnerCycle(problem) {
...
var SAT = function (_Problem) {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(SAT, [{
        ...
        key: 'getProblemCost',
        value: function getProblemCost(bitArrayConfig) {
...
var GeneticSolver = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(GeneticSolver, [{
        ...
        value: function solve(problem, params) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_3__common_Result__["a" /* default */](this.result, this.bestCost, this.counter);
        }
    }, {
        key: '_initGeneration',
...
var TravellingSalesman = function (_Problem) {
    ...
    function TravellingSalesman(data) {
        ...
        _this._noNodes = +data[0];
        _this._noEdges = +data[1];
        _this._noNodesToVisit = +data[2];
        _this._maxPrice = +data[3];
        _this._nodesToVisit = [];

        for (var i = 0; i < _this._noNodesToVisit; i++) {
            _this._nodesToVisit.push(+data[4 + i]);
        }
        ...
        for (var i = 0; i < _this._noNodes; i++) {
            for (var j = 0; j < _this._noNodes; j++) {
                if (+data[4 + _this._noNodesToVisit + i * _this._noNodes + j] !== 0 || i === j) {
                    _this._distanceArray[i][j] = +data[4 + _this._noNodesToVisit + i * _this._noNodes + j];
...
var TabuSolver = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(TabuSolver, [{
        ...
        value: function solve(problem, params) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_2__common_Result_js__["a" /* default */](problem.getResult(best), this.problem.getProblemCost(best), this.counter);
        }
    }]);
...
/******/ });
//# sourceMappingURL=911136bbc5961de8366b.worker.js.map